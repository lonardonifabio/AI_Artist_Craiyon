...
if st.button("Draw"):
    ...
    with col1:
        st.image(image = Image.open(BytesIO(base64.decodebytes(0))))
        st.image(image = Image.open(BytesIO(base64.decodebytes(1))))
        st.image(image = Image.open(BytesIO(base64.decodebytes(2))))
    ...
    with col2:
        st.image(image = Image.open(BytesIO(base64.decodebytes(3))))
        st.image(image = Image.open(BytesIO(base64.decodebytes(4))))
        st.image(image = Image.open(BytesIO(base64.decodebytes(5))))
    ...
    with col3:
        st.image(image = Image.open(BytesIO(base64.decodebytes(6))))
        st.image(image = Image.open(BytesIO(base64.decodebytes(7))))
        st.image(image = Image.open(BytesIO(base64.decodebytes(8))))
